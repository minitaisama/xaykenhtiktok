...
router.put('/:id', authenticate, requireRole('admin', 'editor'), ProjectsController.update);
...
router.put('/batch/reorder', authenticate, requireRole('admin', 'editor'), ProjectsController.reorder);
